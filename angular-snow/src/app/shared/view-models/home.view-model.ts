...
export class HomeViewModel
{
    ...
    public menuItems: MenuItem[] = 
        [
            ...
            new MenuItem("AR Demo", "AR.js experiments", "/ar-demo", "fa-solid fa-chart-scatter-3d"),
            new MenuItem("Network science", "Presentation for Social Networks Ananlysis", "/network-science", "fa-solid fa-diagram-project")
        ];
